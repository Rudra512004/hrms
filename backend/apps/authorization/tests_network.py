...
class NetworkPolicyTests(TestCase):
    ...
    def test_office_network_allowed(self):
        ...
        self.assertTrue(NetworkAccessService.is_office_network_allowed('203.0.113.50', self.org))
        # 203.0.114.50 is outside
        self.assertFalse(NetworkAccessService.is_office_network_allowed('203.0.114.50', self.org))
